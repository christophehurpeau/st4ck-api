...
if (!databasesModelsConfig.hasOwnProperty('*')) {
...
module.exports = (id) => {
  if (!cache.hasOwnProperty(id)) {
    ...
    const databaseId = databasesModelsConfig.hasOwnProperty(id) ? databasesModelsConfig[id] : databasesModelsConfig['*'];
    if (!databases.hasOwnProperty(databaseId)) {
